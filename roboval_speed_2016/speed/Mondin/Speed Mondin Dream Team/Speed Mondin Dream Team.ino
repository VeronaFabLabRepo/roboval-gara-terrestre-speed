...
/*
 * @scuola:	Stimate
 * @autori:	Vanini, Signoretto, Vaccarolo
 * Squadra: Mondin Deam Team
 * Robot:   L3
 * @data:   Maggio 2016
 * Versione: - 
 * @evento: Roboval 2016
...
#define correction_speed 2 // velocita' di correzione traiettoria rettilinea (0-100)
#define turn_speed 24 // velocita' di curvatura (0-100)
#define debugPeriod 1000 // ogni quanti millisecondi inviare i messaggi di debug
#define soglia 350 // soglia di riconoscimento bianco/nero (0-1000)
