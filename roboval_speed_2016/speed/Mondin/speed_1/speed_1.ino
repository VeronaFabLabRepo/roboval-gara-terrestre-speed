...
/*
 * @scuola:	Stimate
 * @autori:	Leonardo Piccoli,Caterina Pezzoli, Francesco Bertolaso.
 * Squadra: L-team
 * Robot:   L1
 * @data:   Maggio 2016
 * Versione: - 
...
//
#define full_speed 46
// velocita' massima (0-100)
...
void straight(){
correction_speed2=correction_speed2/2;
