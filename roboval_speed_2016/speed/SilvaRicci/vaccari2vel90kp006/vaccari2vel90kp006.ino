//meglio alle curve, rettilineo oscilla, tempo medio 6.95

#include <QTRSensors.h>
#define Kp 0.06//0.3//0.1
#define Kd 1.70//1.50//1.70 //0.85
#define out_STBY    7
...
#define baseSpeed 90//80 //di default 50 this is the speed at which the motors should spin when the robot is perfectly on the line
