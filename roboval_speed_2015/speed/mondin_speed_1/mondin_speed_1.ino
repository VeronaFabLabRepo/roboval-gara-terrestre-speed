...
/*
*Scuola Lavinia Mondin
Mella -Montresor - Speed
 */
...
#define full_speed          90 // velocita' massima (0-100)
#define correction_speed    25// velocita' di correzione traiettoria rettilinea (0-100)
