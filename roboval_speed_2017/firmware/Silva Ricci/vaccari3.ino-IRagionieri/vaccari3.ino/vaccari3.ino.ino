//scattoso alle curve, rettilineo buono, tempo medio 7 zt
#include <QTRSensors.h>
#define Kp 0.035//0.3//0.1
#define Kd 1.60//1.50//1.70 //0.85
#define out_STBY    7
...
#define baseSpeed 95//80 //di default 50 this is the speed at which the motors should spin when the robot is perfectly on the line
